...
<head>
    ...
    <style>
        ...
        .card input[type="number"] { width: 70px; padding: 10px; border: 1px solid #29ca44; border-radius: 6px; }
        .card button { flex: 1; min-width: 120px; padding: 11px 14px; border: none; border-radius: 8px; background: #55dc79; color: #fff; cursor: pointer; }
